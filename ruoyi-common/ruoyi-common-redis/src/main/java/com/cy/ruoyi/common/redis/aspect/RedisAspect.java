package com.cy.ruoyi.common.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.cy.ruoyi.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.cy.ruoyi.common.redis.annotation.RedisEvict)")
