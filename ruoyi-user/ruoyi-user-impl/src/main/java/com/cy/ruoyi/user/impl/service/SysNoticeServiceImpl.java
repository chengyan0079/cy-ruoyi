...
import com.cy.ruoyi.user.api.mapper.SysNoticeMapper;
 ...
 */
@Service
@org.apache.dubbo.config.annotation.Service(validation = "true", version = "${dubbo.provider.ISysNoticeService.version}")
