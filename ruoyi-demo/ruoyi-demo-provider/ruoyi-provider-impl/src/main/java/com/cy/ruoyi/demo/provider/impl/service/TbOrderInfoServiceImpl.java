...
import com.cy.ruoyi.demo.provider.api.mapper.TbOrderInfoMapper;
...
public class TbOrderInfoServiceImpl extends ServiceImpl<TbOrderInfoMapper, TbOrderInfo> implements ITbOrderInfoService {
    ...
    @Override
    public int insertOrder(TbOrderInfo orderInfo) {
        return orderInfoMapper.insertOrder(orderInfo);
    }

    @Override
    public int updateOrder(TbOrderInfo orderInfo) {
