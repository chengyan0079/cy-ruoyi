...
CREATE TABLE `tb_order_info` (
  ...
  `user_id` varchar(100) NOT NULL COMMENT '用户表id',
  ...
  `pay_status` int(2) NOT NULL COMMENT '订单交易状态 0-未支付 1-支付中 2-支付成功 3-支付失败',
  ...
  `create_time` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '创建时间',
  `pay_time` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '支付时间',
  `update_time` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '更新时间',
