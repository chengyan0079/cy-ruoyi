...
import com.cy.ruoyi.admin.sys.base.entity.SysRoleDept;
import com.cy.ruoyi.admin.sys.base.entity.SysRoleMenu;
import com.cy.ruoyi.admin.sys.base.entity.SysUserRole;
import com.cy.ruoyi.admin.sys.base.mapper.SysRoleDeptMapper;
import com.cy.ruoyi.admin.sys.base.mapper.SysRoleMapper;
import com.cy.ruoyi.admin.sys.base.mapper.SysRoleMenuMapper;
import com.cy.ruoyi.admin.sys.base.mapper.SysUserRoleMapper;
...
//    @DataScope(deptAlias = "d")
     ...
     */
    @Override
    public PageUtils selectRoleList(PageDomain pageDomain, SysRole role)
    {
        if (RegexUtil.isNull(role)) {
            role = new SysRole();
        }
        IPage<SysRole> page = roleMapper.selectRoleList(new Query<SysRole>(pageDomain).getPage(), role);
